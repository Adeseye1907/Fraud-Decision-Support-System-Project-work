...
# ============================================================
...
elif page == "Feedback Learning Pipeline" or (locals().get("current_page") == "Feedback Learning Pipeline"):
    ...
    with k4:
        st.markdown(
            f"""
            <div class="pipe-kpi-card">
                <div class="pipe-kpi-label">Pending Adjudication</div>
    ...
    with col_dist:
        ...
        if valid_count > 0:
            ...
            st.info("No validated feedback records available yet. Adjudicate cases in Operational Feedback to populate distribution charts.")
