    ...
    [
        {
            ...
            "Function": "Receives transaction events in real time",
            "Status": "Operational",
        },
        {
            "Stage": "2. Fraud Detection",
            "Component": "Random Forest",
            "Function": "Classifies transactions as FRAUD or LEGITIMATE",
            "Status": "Operational",
        },
        {
            "Stage": "3. Explainability",
            "Component": "SHAP + LIME",
            "Function": "Explains the factors contributing to each prediction",
            "Status": "Operational",
        },
        {
            "Stage": "4. Adaptive Monitoring",
            "Component": "Drift Detection",
            "Function": "Monitors changes in transaction and model behaviour",
            "Status": "Operational",
        },
        {
            "Stage": "5. Model Adaptation",
            "Component": "Adaptation Mechanism",
            "Function": "Identifies when model review or updating may be required",
            "Status": "Operational",
        },
        {
            "Stage": "6. Operational Feedback",
            "Component": "Feedback Mechanism",
            "Function": "Captures operational review and transaction feedback",
            "Status": "Operational",
        },
        {
            "Stage": "7. Feedback to Learning",
            "Component": "Model Learning Pipeline",
            "Function": "Uses validated feedback to support future model improvement",
            "Status": "Operational",
        },
        {
            "Stage": "8. Cost / Value Framing",
            "Component": "Decision Support",
            "Function": "Supports decisions using fraud risk, false alarms and operational value",
            "Status": "Operational",
        },
        {
            "Stage": "9. Final DSS Integration",
