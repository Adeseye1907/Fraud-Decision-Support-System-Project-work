...
# ============================================================
# TRENDS & MONITORING CHART HELPERS (DARK THEME & HIGH CONTRAST)
# ============================================================
...
def create_volume_trend_chart(trend_df):
    ...
    fig.update_layout(
        ...
        legend=dict(orientation="h", y=-0.2, x=0.5, xanchor="center", font=dict(color="#ffffff")),
        xaxis=dict(
            title=dict(text="Timeline Window", font=dict(color="#ffffff", size=12)),
...
def create_rate_and_risk_trend_chart(trend_df):
    ...
    fig.update_layout(
        ...
        yaxis=dict(
            ...
            range=[0, max(100, trend_df["fraud_rate"].max() + 10, trend_df["avg_risk_score"].max() + 10)],
            tickfont=dict(color="#ffffff", size=11),
            gridcolor="#262633",
            showgrid=True
        )
