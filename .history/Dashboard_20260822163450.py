...
# ============================================================
    ...
    st.write(
        ...
        machine learning fraud detection model using
        the historical test dataset.
        """
    )
    ...
    if historical_summary is None:
        ...
        st.warning(
            """
            Historical model results are not available.
        ...
        with c1:
            ...
            st.metric(
                "ROC-AUC",
                f"{historical_summary['roc_auc']:.4f}"
            )
        ...
        with c2:
            ...
            st.metric(
                "PR-AUC",
                f"{historical_summary['pr_auc']:.4f}"
            )
        ...
        with c3:
            ...
            st.metric(
                "Fraud Precision",
                f"{historical_summary['fraud_precision']:.2%}"
            )
        ...
        with c4:
            ...
            st.metric(
                "Fraud Recall",
                f"{historical_summary['fraud_recall']:.2%}"
            )
        ...
        with c5:
            ...
            st.metric(
                "F1-Score",
                f"{historical_summary['fraud_f1']:.2%}"
            )
        ...
        with c6:
            ...
            st.metric(
                "Fraud Caught",
                historical_summary["fraud_caught"]
            )
        ...
        with c7:
            ...
            st.metric(
                "Fraud Missed",
                historical_summary["fraud_missed"]
            )
        ...
        with c8:
            ...
            st.metric(
                "False Alarms",
                historical_summary["false_alarms"]
            )
        ...
        with d1:
            ...
            st.metric(
                ...
                f"{historical_summary['total_transactions']:,}"
            )
        ...
        with d2:
            ...
            st.metric(
                "Actual Fraud Cases",
                historical_summary["actual_fraud_count"]
            )
        ...
        with d3:
            ...
            st.metric(
                "Detection Rate",
                f"{historical_summary['detection_rate']:.2%}"
            )
        ...
        st.write(
            ...
            fraud predictions across the historical dataset.
            """
        )
        ...
        if historical_shap is not None:
            ...
            st.info(
                """
                Global SHAP results are not available.
        ...
        if historical_predictions is not None:
            ...
            st.info(
                "Historical prediction results are not available."
            )
