...
# ============================================================
    ...
    st.write(
        "Evaluation and interpretation of the trained Random Forest fraud detection model using the historical test dataset."
    )
    ...
    if historical_summary is None:
        ...
        st.warning(
            "historical_summary.json could not be found. Run historical_batch.py first."
        )
        ...
        st.info(
            "Global SHAP analysis identifies the features that have the greatest influence on the Random Forest model's fraud predictions across the historical test dataset."
        )
...
# ============================================================
    ...
    st.write(
        ...
        The system provides the fraud prediction together with both
    ...
    if model_error is not None:
        ...
        with tab_manual:
            ...
            st.caption(
                "V1-V28 are anonymised PCA-transformed features. Use actual transaction feature values when available."
            )
            ...
            if submitted:
                ...
                try:
                    ...
                    with lime_tab:
                        ...
                        st.info(
                            """
                            LIME provides a local approximation of the model's
                            decision around this particular transaction.

                            Positive weights indicate evidence supporting
                            the FRAUD class, while negative weights indicate
                            evidence supporting the LEGITIMATE class.
                            """
                        )
                        ...
                        st.caption(
                            "LIME explanations are local and may vary slightly between runs because LIME uses a local sampling process."
                        )
...
# ============================================================
    ...
    st.write(
        "An intelligent interface for assisting operational users in interpreting fraud detection results, transaction risk and model explanations."
    )
...
# ============================================================
    ...
    st.write(
        ...
        **SHAP:** Used for global feature importance and local feature contribution.

        **LIME:** Used as a complementary local explanation method for individual predictions.
        """
    )
