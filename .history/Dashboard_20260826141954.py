...
# ============================================================
    ...
    # Poll live Kafka stream records
    read_kafka_transactions()
    ...
    st.markdown(
        ...
        <div class="dashboard-header">
            <div>
                ...
                <div class="dashboard-subtitle">
                    Monitors live stream dynamics against the Random Forest training baseline to detect covariate shift and concept drift.
                </div>
            </div>
            <div class="live-badge">
        ...
        if "fraud_probability" in live_df.columns:
            ...
            if not probs.empty:
                ...
                if mean_probability > 30.0:
                    drift_score += 0.35
                    drift_reasons.append("Elevated average Random Forest fraud risk probability (> 30.00%)")
            ...
            for feat in monitored_features:
                if feat in historical_df.columns and feat in live_df.columns:
                    ...
                    if len(live_vals) >= 10:
                        ...
                        # Detect significant statistical shift
    ...
    with k2:
        st.markdown(
            ...
            <div class="adaptive-kpi-card">
                ...
                <div class="adaptive-kpi-sub">RF Baseline: {baseline_fraud_rate:.2f}%</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with k3:
        st.markdown(
            ...
            <div class="adaptive-kpi-card">
                ...
                <div class="adaptive-kpi-sub">RF Baseline Expected: {baseline_avg_risk:.2f}%</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with k4:
        st.markdown(
            ...
            <div class="adaptive-kpi-card">
                ...
                <div class="adaptive-kpi-val" style="color: {status_color} !important; font-size: 20px;">
                    {drift_score:.2f} ({drift_status})
                </div>
                <div class="adaptive-kpi-sub">Model Health Indicator</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with c1:
        st.markdown(
            ...
            <div class="dashboard-panel">
                ...
                <div class="panel-subtitle">Compares historical training label distribution against live Random Forest classifications.</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with c2:
        st.markdown(
            ...
            <div class="dashboard-panel">
                ...
                <div class="panel-subtitle">Distribution of output probabilities generated by the Random Forest engine.</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
        ...
        if transaction_count >= 10 and "fraud_probability" in live_df.columns:
            ...
            st.info("Accumulating transactions to display the Random Forest confidence distribution.")

    # --------------------------------------------------------
    # MONITORING ASSESSMENT & ADVISORY
    # --------------------------------------------------------
