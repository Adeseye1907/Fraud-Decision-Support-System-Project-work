...
# ============================================================
    ...
    if view_mode == "Live Real-Time Stream":
        ...
        # Macro population baseline constants
        TOTAL_HISTORICAL_TXS = 283726
        TOTAL_HISTORICAL_FRAUD = 473
        TOTAL_HISTORICAL_RATE = 0.17

        # Hold-out test evaluation baseline (N = 56,746)
        ...
        tx_desc = "Out-of-sample evaluation sample (20% Split)"
        fraud_desc = "Evaluation ground-truth fraud cases"
    ...
    # --------------------------------------------------------
    # TOTAL HISTORICAL DATA ROW (DISPLAYED IN HISTORICAL VIEW)
    # --------------------------------------------------------
    if view_mode == "Historical Analysis":
        st.markdown("""<div class="section-title">Total Historical Corpus (Pre-Split Population)</div>""", unsafe_allow_html=True)
        ...
        with h1:
            st.markdown(
                ...
                <div class="kpi-card">
                    ...
                    <div class="kpi-label">Total Historical Transactions</div>
                    <div class="kpi-value">{TOTAL_HISTORICAL_TXS:,}</div>
                    <div class="kpi-description">Full sanitized & deduplicated dataset</div>
                </div>
                """,
                unsafe_allow_html=True
            )
        ...
        with h2:
            st.markdown(
                ...
                <div class="kpi-card">
                    ...
                    <div class="kpi-label">Total Historical Fraud</div>
                    <div class="kpi-value">{TOTAL_HISTORICAL_FRAUD:,}</div>
                    <div class="kpi-description">Total verified fraud instances</div>
                </div>
                """,
                unsafe_allow_html=True
            )
        ...
        with h3:
            st.markdown(
                ...
                <div class="kpi-card">
                    <div class="kpi-icon">📉</div>
                    <div class="kpi-label">Historical Fraud Rate</div>
                    <div class="kpi-value">{TOTAL_HISTORICAL_RATE:.2f}%</div>
                    <div class="kpi-description">Macro portfolio fraud prevalence</div>
                </div>
                """,
                unsafe_allow_html=True
            )

        st.markdown("""<div class="section-title">Model Evaluation Benchmark (Hold-Out Test Split)</div>""", unsafe_allow_html=True)

    # --------------------------------------------------------
    # KPI CARDS (TEST SPLIT / LIVE STREAM)
    # --------------------------------------------------------
    ...
    with e1:
        if view_mode == "Live Real-Time Stream":
            ...
            exp_text = f"The total historical corpus comprises <b>{TOTAL_HISTORICAL_TXS:,}</b> transactions with <b>{TOTAL_HISTORICAL_FRAUD:,}</b> fraud events ({TOTAL_HISTORICAL_RATE:.2f}%). The evaluation split validates the model across <b>{total_count:,}</b> unseen records."
...
# ============================================================
    ...
    st.markdown(
        ...
        /* High-contrast custom container for High-Risk Metric */
        .high-risk-kpi-card {
    ...
    if not raw_df.empty:
        ...
        with col_slider:
            ...
            # Replaced plain st.metric with styled, high-contrast HTML block
            st.markdown(
                f"""
                <div class="high-risk-kpi-card">
                    <div class="high-risk-kpi-title">High-Risk Transactions</div>
                    <div class="high-risk-kpi-value">{high_risk_count:,}</div>
                    <div class="high-risk-kpi-sub">{high_risk_ratio:.2f}% of stream</div>
                </div>
                """,
                unsafe_allow_html=True
            )
...
# ============================================================
...
elif page == "About the Framework" or (locals().get("current_page") == "About the Framework"):
    ...
    st.markdown(
        ...
        <div class="about-top-bar">
            <div style="flex: 1;">
                <div class="about-title-main">About the Framework</div>
                <div class="about-sub-main">
                    Adaptive and interpretable fraud detection and operational decision support.
                </div>
            </div>
            <div class="live-badge" style="flex-shrink: 0; white-space: nowrap; font-size: 11px; padding: 6px 14px;">
    ...
    st.markdown(
        ...
        <div class="about-card">
            <div class="about-header">Prototype / Reference Implementation</div>
            <div class="about-body">
                This system is a prototype and reference implementation demonstrating how machine learning (Random Forest),
                explainable AI (SHAP & LIME), real-time event streaming (Apache Kafka), adaptive drift monitoring, 
                and operational decision support integrate into an end-to-end fraud management architecture.
                <br><br>
                The implementation is designed to evaluate framework mechanisms, human-in-the-loop triage workflows, 
                and adaptive model governance concepts within digital banking environments rather than serving as a production deployment.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
