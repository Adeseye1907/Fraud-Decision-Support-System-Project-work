...
# ============================================================
    ...
    st.markdown(
        """
        <div class="dashboard-header" style="display: flex; justify-content: space-between; align-items: center; gap: 16px; margin-bottom: 14px;">
            ...
            <div class="live-badge" style="flex-shrink: 0; white-space: nowrap; font-size: 11.5px; padding: 5px 12px;">
    ...
    # --------------------------------------------------------
    # 1. LIVE SYSTEM STATUS CARDS (HIGH-CONTRAST VISIBILITY)
    # --------------------------------------------------------
    ...
    # Crisp indicator colors
    kafka_badge = '<span style="color: #15803d; font-weight: 800;">● ONLINE</span>' if kafka_online else '<span style="color: #b91c1c; font-weight: 800;">○ STANDBY</span>'
    model_badge = '<span style="color: #15803d; font-weight: 800;">● LOADED</span>' if model_loaded else '<span style="color: #b91c1c; font-weight: 800;">○ OFFLINE</span>'
    lime_badge = '<span style="color: #15803d; font-weight: 800;">● ACTIVE</span>' if lime_ready else '<span style="color: #b91c1c; font-weight: 800;">○ OFFLINE</span>'
    ...
    with s1:
        st.markdown(
            f"""
            <div style="background:#ffffff; border:1px solid #cbd5e1; border-radius:12px; padding:16px 18px; box-shadow:0 4px 12px rgba(15,23,42,0.05); min-height:115px;">
                <div style="font-size:11.5px; font-weight:800; color:#475569; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:8px;">KAFKA STREAM</div>
                <div style="font-size:20px; line-height:1.2; margin-bottom:6px;">{kafka_badge}</div>
                <div style="font-size:12px; font-weight:600; color:#334155;">Topic: fraud-predictions</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with s2:
        st.markdown(
            f"""
            <div style="background:#ffffff; border:1px solid #cbd5e1; border-radius:12px; padding:16px 18px; box-shadow:0 4px 12px rgba(15,23,42,0.05); min-height:115px;">
                <div style="font-size:11.5px; font-weight:800; color:#475569; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:8px;">PREDICTIVE MODEL</div>
                <div style="font-size:20px; line-height:1.2; margin-bottom:6px;">{model_badge}</div>
                <div style="font-size:12px; font-weight:600; color:#334155;">Random Forest Ensemble</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with s3:
        st.markdown(
            f"""
            <div style="background:#ffffff; border:1px solid #cbd5e1; border-radius:12px; padding:16px 18px; box-shadow:0 4px 12px rgba(15,23,42,0.05); min-height:115px;">
                <div style="font-size:11.5px; font-weight:800; color:#475569; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:8px;">EXPLAINABILITY (XAI)</div>
                <div style="font-size:20px; line-height:1.2; margin-bottom:6px;">{lime_badge}</div>
                <div style="font-size:12px; font-weight:600; color:#334155;">SHAP & LIME Engines</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with s4:
        st.markdown(
            f"""
            <div style="background:#ffffff; border:1px solid #cbd5e1; border-radius:12px; padding:16px 18px; box-shadow:0 4px 12px rgba(15,23,42,0.05); min-height:115px;">
                <div style="font-size:11.5px; font-weight:800; color:#475569; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:8px;">ADAPTIVE STATE</div>
                <div style="font-size:18px; font-weight:800; color:{drift_color}; line-height:1.2; margin-bottom:6px;">● {drift_status}</div>
                <div style="font-size:12px; font-weight:600; color:#334155;">Continuous Governance</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    # --------------------------------------------------------
    # 2. SEQUENTIAL WORKFLOW WHITE CARDS (COMPACT TYPOGRAPHY)
    # --------------------------------------------------------
    workflow = [
