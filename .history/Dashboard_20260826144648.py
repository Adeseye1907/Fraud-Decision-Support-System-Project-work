...
# ============================================================
...
elif page == "Operational Feedback" or (locals().get("current_page") == "Operational Feedback"):
    ...
    if not stream_txs:
        ...
        with col_select:
            selected_option = st.selectbox("Select Transaction to Adjudicate", transaction_options)
        ...
        with col_form:
            st.markdown(
                """
                <div class="dashboard-panel">
                    <div class="panel-title">Investigator Adjudication Form</div>
            ...
            with st.form("investigator_feedback_form"):
                ...
                with col_btn:
                    submit_feedback = st.form_submit_button("💾 Commit Adjudication Record", use_container_width=True)
