...
if page == "Introduction":
    ...
    st.markdown(
        ...
        <div class="dashboard-panel">
            ...
            <div class="insight-text">
                ...
                The rapid growth of digital banking and
                electronic payment systems has increased the
                volume, velocity and complexity of financial
                transactions. At the same time, this growth has
                created opportunities for increasingly
                sophisticated fraudulent activities.

                <br><br>

                Machine learning provides an opportunity to
                identify complex patterns within transaction
                data and detect potentially fraudulent
                behaviour. However, predictive performance
                alone is insufficient for effective operational
                fraud management.

                <br><br>

                Operational teams need to understand not only
                whether a transaction has been classified as
                potentially fraudulent, but also why the machine
                learning model reached that decision.

                <br><br>

                This framework therefore combines fraud
                prediction, explainable AI, real-time monitoring,
                adaptive monitoring and operational decision
                support.
    ...
    st.markdown(
        ...
        <div class="section-subtitle">
            The framework is designed around three complementary
            areas of fraud detection and decision support.
        </div>
        """,
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        ...
        <div class="section-subtitle">
            From historical data development to real-time
            operational decision support.
        </div>
        """,
        unsafe_allow_html=True
    ...
    with a1:
        ...
        st.markdown(
            ...
            <div class="dashboard-panel">
                ...
                <div class="status-row">
                    <span>Accuracy</span>
                    <span class="status-good">100.00%</span>
                </div>

                <div class="status-row">
                    <span>Precision</span>
                    <span class="status-good">90.00%</span>
                </div>

                <div class="status-row">
                    <span>Recall</span>
                    <span class="status-good">77.00%</span>
                </div>

                <div class="status-row">
                    <span>F1-Score</span>
                    <span class="status-good">83.00%</span>
                </div>

                <div class="status-row">
                    <span>ROC-AUC</span>
                    <span class="status-good">96.06%</span>
                </div>

                <div class="status-row">
                    <span>PR-AUC</span>
                    <span class="status-good">81.27%</span>
                </div>
        ...
        st.markdown(
            ...
            <div class="insight-card">
                ...
                <div class="insight-text">
                    ...
                    These metrics provide an indication of the
...
# ============================================================
    ...
    with tab2:
        ...
        st.markdown(
            ...
            Upload a CSV containing the transaction features
...
# ============================================================
    ...
    st.markdown(
        ...
        <div class="dashboard-header">
            ...
            <div>
                ...
                <div class="dashboard-subtitle">
                    Monitor transaction behaviour and fraud
    ...
    if amount_chart is not None:
        ...
        st.info(
            "Transaction amount data unavailable."
        )
...
# ============================================================
    ...
    st.info(
        "Adaptive monitoring layer available for drift analysis, "
        "distribution monitoring and model-performance tracking."
    )
...
# ============================================================
    ...
    st.markdown(
        ...
        <div class="dashboard-header">
            ...
            <div>
                ...
                <div class="dashboard-subtitle">
                    Framework for incorporating new transaction
                    patterns and validated feedback into future
                    model updates.
                </div>
    ...
    st.info(
        "Model adaptation is represented as a controlled "
        "framework process rather than automatic retraining."
    )
...
# ============================================================
    ...
    st.markdown(
        ...
        <div class="dashboard-header">
            ...
            <div>
                ...
                <div class="dashboard-subtitle">
                    Capture operational review outcomes for
                    future learning and model improvement.
                </div>
    ...
    if st.button(
        ...
        st.success(
            "Feedback recorded for the prototype workflow."
        )
...
# ============================================================
    ...
    st.markdown(
        ...
        <div class="dashboard-header">
            ...
            <div>
                ...
                <div class="dashboard-subtitle">
                    Operational feedback can support validation,
                    retraining and future model adaptation.
                </div>
    ...
    st.info(
        "Operational feedback → validation → curated training "
        "data → model adaptation → evaluation."
    )
...
# ============================================================
    ...
    st.markdown(
        ...
        <div class="dashboard-header">
            ...
            <div>
                ...
                <div class="dashboard-subtitle">
                    Fraud decisions can be evaluated using
                    operational cost and potential value.
                </div>
    ...
    st.info(
        "This module provides a conceptual framework for "
        "comparing false-positive, false-negative and review costs."
    )
        ...
        <div class="dashboard-header">
            ...
            <div>
                ...
                <div class="dashboard-subtitle">
                    ...
                    fraud detection and operational review.
                </div>
...
# ============================================================
    ...
    st.markdown(
        ...
        <div class="dashboard-header">
            ...
            <div>
                ...
                <div class="dashboard-subtitle">
                    Interpret fraud signals and support
                    risk-aware operational review.
                </div>
    ...
    question = st.text_area(
        "Ask about the fraud decision-support framework"
    )
    ...
    if st.button(
        ...
        if question.strip():
            ...
            st.info(
                "The decision assistant can be connected to "
                "the model, XAI outputs and operational rules."
            )
    ...
    st.markdown(
        ...
        <div class="dashboard-panel">
            ...
            <div class="insight-text">
                ...
                learning, explainable AI, real-time event
                streaming, adaptive monitoring and operational
                decision support can be integrated into a
                fraud-detection framework.

                <br><br>

                The implementation is intended to demonstrate
                the framework architecture and decision-support
                concepts rather than represent a production
                banking deployment.
