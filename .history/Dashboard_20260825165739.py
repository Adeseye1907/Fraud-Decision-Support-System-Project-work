...
# ============================================================
    ...
    # Scoped CSS to enforce high-contrast tabs, subheaders, and input labels
    st.markdown(
        """
        <style>
        ...
        button[data-baseweb="tab"][aria-selected="true"] {
            background-color: #1e3a8a !important; /* Premium deep navy */
    ...
    with tab1:
        ...
        st.caption("V1–V28 are anonymised PCA-transformed features. Zero values can be used for testing.")
    ...
    with tab2:
        ...
        st.caption("Upload a CSV containing the transaction features required by the trained model.")
        ...
        if uploaded_file is not None:
            ...
            if st.button("🚀 Predict Batch", use_container_width=True):
                ...
                for _, row in batch_df.iterrows():
                    res = predict_fraud_transaction(row.to_dict())
                    results.append({
