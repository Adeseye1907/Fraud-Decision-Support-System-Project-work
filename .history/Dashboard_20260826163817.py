...
# ============================================================
    ...
    # --------------------------------------------------------
    # 1. LIVE SYSTEM STATUS CARDS (HIGH-CONTRAST COLORS)
    # --------------------------------------------------------
    ...
    workflow = [
        ...
        ("02", "Machine Learning", "Random Forest classifier detects transaction-level fraud risk and outputs risk probabilities."),
