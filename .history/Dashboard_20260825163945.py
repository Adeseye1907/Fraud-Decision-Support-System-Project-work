...
# ============================================================
    ...
    st.markdown(
        ...
        <div class="historical-section-description">
            Understanding which transaction features have the
            greatest influence on the Random Forest fraud predictions.
        </div>
        """,
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        ...
        <div class="historical-info-box">
            ...
            influence on model predictions across the historical
            dataset.
    ...
    if (
        historical_shap_page is not None
        ...
        if (
            ...
            and
            "Mean_Abs_SHAP" in historical_shap_page.columns
        ):
    ...
    if (
        historical_predictions_page is not None
        and
        "prediction" in historical_predictions_page.columns
    ):
    ...
    st.markdown(
        """
        <div class="historical-section-description">
            Historical model predictions showing the classification
            outcome, fraud probability and available ground-truth label.
        </div>
        """,
        unsafe_allow_html=True,
    )
