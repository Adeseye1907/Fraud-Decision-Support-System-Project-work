...
# ============================================================
    ...
    with k1:
        st.markdown(
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-value">{HISTORICAL_TRANSACTIONS:,}</div>
    ...
    with k2:
        st.markdown(
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-value">{HISTORICAL_FRAUD:,}</div>
                <div class="kpi-description">Identified fraudulent transactions</div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with k3:
        st.markdown(
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-value">{HISTORICAL_FRAUD_RATE:.2f}%</div>
                <div class="kpi-description">Fraud proportion in historical data</div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with k4:
        st.markdown(
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-description">Model discrimination performance</div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with k5:
        st.markdown(
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-value">{MODEL_PR_AUC:.2f}%</div>
    ...
    with c1:
        st.markdown(
            """
            <div class="dashboard-panel">
                <div class="panel-title">Transaction Risk Distribution</div>
                <div class="panel-subtitle">Historical fraud and legitimate transaction profile</div>
            </div>
            """,
            unsafe_allow_html=True
        )
        st.plotly_chart(
            create_donut_chart(HISTORICAL_FRAUD, HISTORICAL_LEGITIMATE),
    ...
    with c2:
        st.markdown(
            ...
            <div class="dashboard-panel">
                ...
                <div class="panel-subtitle">Evaluation metrics from the Random Forest model</div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with a1:
        st.markdown(
            ...
            <div class="dashboard-panel">
                <div class="status-row"><span>Accuracy</span><span class="status-good">100.00%</span></div>
                <div class="status-row"><span>Precision</span><span class="status-good">90.00%</span></div>
                <div class="status-row"><span>Recall</span><span class="status-good">77.00%</span></div>
                <div class="status-row"><span>F1-Score</span><span class="status-good">83.00%</span></div>
                <div class="status-row"><span>ROC-AUC</span><span class="status-good">96.06%</span></div>
                <div class="status-row"><span>PR-AUC</span><span class="status-good">81.27%</span></div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with a2:
        st.markdown(
            ...
            <div class="dashboard-panel">
                <div class="status-row"><span>Transaction Ingestion</span><span class="status-good">● ACTIVE</span></div>
                <div class="status-row"><span>Kafka Event Streaming</span><span class="status-good">● READY</span></div>
                <div class="status-row"><span>Fraud Classification</span><span class="status-good">● ACTIVE</span></div>
                <div class="status-row"><span>Explainability Layer</span><span class="status-good">● READY</span></div>
                <div class="status-row"><span>Adaptive Monitoring</span><span class="status-good">● ACTIVE</span></div>
                <div class="status-row"><span>Decision Support Dashboard</span><span class="status-good">● ACTIVE</span></div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with e1:
        st.markdown(
            ...
            <div class="insight-card">
                <div class="insight-title">Fraud Exposure</div>
                <div class="insight-text">
                    The historical dataset contains <b>{HISTORICAL_FRAUD:,}</b> identified fraudulent transactions out of <b>{HISTORICAL_TRANSACTIONS:,}</b> transactions analysed. This represents a fraud rate of <b>{HISTORICAL_FRAUD_RATE:.2f}%</b>.
                </div>
            </div>
            """,
            unsafe_allow_html=True
    ...
    with e2:
        st.markdown(
            ...
            <div class="insight-card">
                ...
                <div class="insight-text">
                    The Random Forest model achieved a ROC-AUC of <b>{MODEL_ROC_AUC:.2f}%</b> and PR-AUC of <b>{MODEL_PR_AUC:.2f}%</b>. These metrics provide an indication of the model's ability to discriminate between fraudulent and legitimate activity.
                </div>
            </div>
            """,
            unsafe_allow_html=True
    ...
    with e3:
        st.markdown(
            f"""
            <div class="insight-card">
                <div class="insight-title">Operational Consideration</div>
                <div class="insight-text">
                    Fraud recall is currently <b>{MODEL_RECALL:.1f}%</b>, while precision is <b>{MODEL_PRECISION:.1f}%</b>. This supports a risk-based operational review process rather than treating every transaction as equally risky.
                </div>
            </div>
            """,
            unsafe_allow_html=True
...
# ============================================================
    ...
    p1, p2 = st.columns(2)
    with p1:
        st.metric("Predicted Fraud", "81")
    with p2:
        st.metric("Predicted Legitimate", "56,665")

    st.markdown("### Historical Prediction Results")
    if historical_df is not None:
        st.dataframe(historical_df.head(100), use_container_width=True, height=400)
