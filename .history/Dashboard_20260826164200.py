...
# ============================================================
    ...
    # --------------------------------------------------------
    # 1. LIVE SYSTEM STATUS CARDS (EXPLICIT INLINE OVERRIDES)
    # --------------------------------------------------------
    ...
    # Set explicit font colors
    kafka_text = "● ONLINE" if kafka_online else "○ STANDBY"
    kafka_color = "#16a34a" if kafka_online else "#dc2626"

    model_text = "● LOADED" if model_loaded else "○ OFFLINE"
    model_color = "#16a34a" if model_loaded else "#dc2626"

    lime_text = "● ACTIVE" if lime_ready else "○ OFFLINE"
    lime_color = "#16a34a" if lime_ready else "#dc2626"
    ...
    with s1:
        st.markdown(
            ...
            <div class="sys-status-card">
                ...
                <div style="font-size: 18px; font-weight: 800; color: {kafka_color} !important; line-height: 1.1;">
                    {kafka_text}
                </div>
    ...
    with s2:
        st.markdown(
            ...
            <div class="sys-status-card">
                ...
                <div style="font-size: 18px; font-weight: 800; color: {model_color} !important; line-height: 1.1;">
                    {model_text}
                </div>
    ...
    with s3:
        st.markdown(
            ...
            <div class="sys-status-card">
                ...
                <div style="font-size: 18px; font-weight: 800; color: {lime_color} !important; line-height: 1.1;">
                    {lime_text}
                </div>
    ...
    with s4:
        st.markdown(
            ...
            <div class="sys-status-card">
                ...
                <div style="font-size: 18px; font-weight: 800; color: {drift_color} !important; line-height: 1.1;">
                    ● {drift_status}
                </div>
