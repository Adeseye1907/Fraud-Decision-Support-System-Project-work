...
# ============================================================
    ...
    if shap_df is not None and not shap_df.empty:
        ...
        if "Feature" in shap_df.columns and "Mean_Abs_SHAP" in shap_df.columns:
            chart_df = shap_df.head(10).sort_values("Mean_Abs_SHAP", ascending=True).set_index("Feature")
    ...
    if preds_df is not None and not preds_df.empty:
        ...
        st.dataframe(target_table.head(100), use_container_width=True, hide_index=True)
