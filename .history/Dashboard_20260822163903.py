...
def load_historical_results():
    ...
    if os.path.exists("historical_summary.json"):
...
# ============================================================
# LOAD MODEL + SHAP + LIME EXPLAINERS
# ============================================================
...
def load_prediction_model():
    ...
    # Random Forest expects 30 model features
    # LIME uses a representative background dataset.
    #
    # We use historical_test_data.csv as the background
    # distribution for generating local explanations.
...
# ============================================================
    ...
    st.write(
        """
        Evaluation and interpretation of the trained Random
        Forest fraud detection model using the historical
        test dataset.
        """
    )
    ...
    try:
        ...
        st.error(
            ...
            successfully and that the following files are in
            the same folder as Dashboard.py:
    ...
    if historical_files_loaded:
        ...
        top_shap = historical_shap.head(10).copy()
        ...
        st.caption(
            """
            The table below contains the model prediction,
            fraud probability and actual historical outcome
        ...
        st.success(
            ...
            The dashboard is now displaying results generated
            directly from historical_batch.py.
            """
        )
