...
# ============================================================
    ...
    if pred_model is None:
        ...
        st.error(
            """
            The trained fraud detection model could not be loaded.

            Please make sure that:

            rf_fraud_model.pkl

            is located in the same folder as Dashboard.py.
            """
        )
    ...
    with tab_manual:
        ...
        st.caption(
            """
            Enter the 30 model features used by the trained
            Random Forest model.

            The model uses Time, Amount and V1–V28.
            """
        )
        ...
        with st.form(
            ...
            st.caption(
                ...
                transaction features from the original
                credit-card dataset.
                """
            )
        ...
        if submitted:
            ...
            st.caption(
                ...
                contributed to the model's fraud prediction.
                """
            )
