...
# ============================================================
    ...
    # --------------------------------------------------------
    # SCOPE TOGGLE STYLING (WHITE PILL CONTAINER)
    # --------------------------------------------------------
    st.markdown(
        """
        <style>
    ...
    # HEADER & VIEW TOGGLE
    # --------------------------------------------------------
    header_col, toggle_col = st.columns([2.8, 1.2])
    ...
    if view_mode == "Live Real-Time Stream":
        ...
        kafka_connected = (
            st.session_state.get("kafka_status", "Disconnected") == "Connected"
        )
    ...
    with k4:
        ...
        st.markdown(
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-value">{roc_auc_display:.2f}%</div>
    ...
    # ========================================================
    # CHARTS (DARK SLATE PANELS & SKY BLUE VISUALS)
    # ========================================================
    c1, c2 = st.columns(2)
    ...
    with c1:
        st.markdown(
            ...
            <div class="dashboard-panel">
                <div class="panel-title">
                    Transaction Risk Distribution ({view_mode})
                </div>
