...
with c2:
    ...
    # Make chart text clearly visible
...
with e1:
    ...
    if view_mode == "Live Real-Time Stream":
        ...
        exp_text = (
            ...
            f"identifying <b>{fraud_count:,}</b> high-risk incidents "
            f"({fraud_rate:.2f}% stream fraud rate)."
        )

    else:

        exp_text = (
            f"The baseline dataset contains "
    ...
    st.markdown(
        ...
        <div class="insight-card">
            ...
            <div class="insight-text">
                ...
                ROC-AUC of <b>{MODEL_ROC_AUC:.2f}%</b> and
                PR-AUC of <b>{MODEL_PR_AUC:.2f}%</b>,
                prioritizing anomalous transaction patterns
...
with e3:
    ...
    drift_note = (
        ...
        "Elevated risk alerts detected in stream"
    )
