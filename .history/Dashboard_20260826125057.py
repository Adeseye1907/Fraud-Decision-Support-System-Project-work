...
# ============================================================
# CHART HELPER FUNCTIONS (Place before page routing)
# ============================================================
...
def create_donut_chart(fraud, legitimate, title=""):
    ...
    fig.update_layout(
        ...
        annotations=[
            dict(
                text=f"<b>{fraud_pct:.2f}%</b><br><span style='font-size:11px;color:#64748b;'>Fraud Rate</span>",
                x=0.5,
                y=0.5,
...
# ============================================================
# 2. EXECUTIVE OVERVIEW (Unbroken elif block)
# ============================================================
    ...
    with c1:
        ...
        if total_count > 0:
            ...
            st.info("No real-time transactions received yet. Ensure the Kafka producer is streaming data.")
